(function(){
  ...
  load();
  render();
  if('serviceWorker' in navigator){window.addEventListener('load',function(){var registration=navigator.serviceWorker.register('legacy-sw.js?v=13');if(registration&&registration.catch){registration.catch(function(){});}});}
}());
