(function(){
  ...
  var state={day:weekday>=1&&weekday<=4?weekday-1:0,todayRest:weekday<1||weekday>4,block:0,set:0,done:{son:false,dad:false},weights:{},reps:{},history:{},completions:{},rest:null,interval:null,menu:false,calendar:false,calendarYear:calendarYear,calendarMonth:calendarMonth,help:null,finish:false};
  ...
  load();
  render();
  if('serviceWorker' in navigator){window.addEventListener('load',function(){var registration=navigator.serviceWorker.register('legacy-sw.js?v=16');if(registration&&registration.catch){registration.catch(function(){});}});}
}());
